...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Mainpg">
        ...
        <%} %>
        <% using (Html.BeginForm("NewBranch", "Branch", FormMethod.Post, new { @id = "frmCreateBranch", enctype = "multipart/form-data" }))
           {%>
        ...
        <table class="mainTable" border="0">
            <tr>
                <td>
                    ...
                    <%:Html.DropDownListFor(model => model.BranchTypeId, (IEnumerable<SelectListItem>)ViewData["BranchTypes"], "Select", new { @class = "selectNone", @id = "branchTypeId" })%>
                    <%: Html.ValidationMessageFor(model => model.BranchTypeId)%>
                </td>
                <td>
                    <%: Html.LabelFor(model => model.CreatedDate) %><span class="required">*</span><br />
            ...
            <tr>
                <td>
                    ...
                    <%:Html.DropDownListFor(model => model.ZonalOfficeId, (IEnumerable<SelectListItem>)ViewData["Zones"], "Select", new { @class = "selectNone", @id = "ZoneId", onchange = "fillSelectedZoneRegionList()" })%>
                ...
                <td>
                    ...
                    <%:Html.DropDownListFor(model => model.RegionalOfficeId, (IEnumerable<SelectListItem>)ViewData["Regions"], "Select", new { @class = "selectNone", @id = "RegionId" })%>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <%: Html.TextBoxFor(model => model.Address1, new { @style = "width:85%;min-width:500px;" })%>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <%: Html.TextBoxFor(model => model.Address2, new { @style = "width:85%;min-width:500px;" })%>
                        ...
                        <div id="uploadImage">
                            ...
                            <span id="divAgentPhoto">
                                <input id="agentPhoto" type="file" name="agentPhoto" style="padding: 5px; width: 300px"
                                    onchange="ChangeImage('agentPhoto','#imgThumbnail2')" /><br />
                                <input type="button" name="resetLogo" value="Reset Image" id="btnReset" onclick="clearFileInput()" /><br />
        ...
        <p>
            <input type="submit" value="Create New Branch" id="submit" title="Create New Branch" />
        </p>
        <% } %>
    </div>
</asp:Content>
