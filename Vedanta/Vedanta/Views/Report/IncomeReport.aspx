...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="pageLink">
            <a href="/Report/Index">
                <img src="../../Images/reports/reports.png" alt="" title="Reports" /></a> <a href="/Admin/Income">
                    <img src="../../Images/list2_add.png" alt="" title="New Income" /></a> <a href="javascript:window.print()">
    ...
    <div id="Mainpg">
        ...
        <div style="width: 100%; padding: 5px;">
            ...
            <%} %>
            <input type="submit" class="btnSearch" id="btnSubmit" name="Submit" value="Search" />
    ...
    <div id="divAdvanceSearch" style="width: 100%; height: 100%; position: fixed; left: 0;
        ...
        <div class="dlgSearchBox">
          <p style="text-align:left">  Enter text in input box to search with proper fields </p>
            ...
            <input type="submit" class="btnSearch" id="btnSubmit" name="Submit" value="Advance Search" />
