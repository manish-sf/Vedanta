...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Mainpg">
        ...
        <%} %>
        <% using (Html.BeginForm("Create", "Client", FormMethod.Post, new { @id = "frmCreateClient", enctype = "multipart/form-data" }))
           {%>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <%: Html.TextBoxFor(model => model.Lane, new { @style = "width:450px" })%>
            ...
            <tr>
                ...
                <td>
                    <%: Html.TextBoxFor(model => model.Street, new { @style = "width:450px" })%>
            ...
            <tr>
                ...
                <td class="editor-field">
                    <%: Html.TextBoxFor(model => model.CreateDate, new {@class="datepicker" })%>
            ...
            <tr>
                ...
                <td class="editor-field">
                    <%: Html.TextBoxFor(model => model.ContractStartDate, new {@class="datepicker" })%>
            ...
            <tr>
                ...
                <td class="editor-field">
                    <%: Html.TextBoxFor(model => model.ContractEndDate, new { @class = "datepicker" })%>
                    <%: Html.ValidationMessageFor(model => model.ContractEndDate) %>
                </td>
            </tr>
            <tr>
                <td class="editor-label">
                    Max. Number Of Branches Allowed To Maintain
                </td>
                <td class="editor-field">
            ...
            <tr>
                <td colspan="2">
                    <input type="submit" value="Add New Client" class="submit" />
                </td>
            </tr>
        </table>
        <% } %>
