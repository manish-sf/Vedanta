                        ...
                        <tr>
                            <td colspan="2">
                                <div style="padding: 2px">
                                    <input type="submit" name="Submit" value="Save Income" class="submit" />
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>
                                <div style="background-color: #f5f5f5; border: 1px solid #c3c3c3; padding: 4px; margin: 0px;
                                    ...
                                    &nbsp; To:
                                    <%:Html.TextBox("txtDateTo", toDate, new { @class = "datepicker", @id = "txtDateTo", @style = "width:100px" })%>
                                    &nbsp;
